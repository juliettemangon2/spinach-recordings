    ...
    <header className={styles.header}>
      ...
      {mobileMenuOpen && (
        <nav className={styles.mobileNav}>
          ...
          <button
            className={`${styles.mobileDropdownTrigger} ${pathname.startsWith('/artists') ? styles.active : ''}`}
          ...
          <button
            className={`${styles.mobileDropdownTrigger} ${pathname.startsWith('/resources') ? styles.active : ''}`}
